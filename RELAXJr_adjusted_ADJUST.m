...
function [art, horiz, vert, blink, disc,...
        soglia_DV, diff_var, soglia_K, med2_K, meanK, soglia_SED, med2_SED, SED, soglia_SAD, med2_SAD, SAD, ...
        soglia_GDSF, med2_GDSF, GDSF, soglia_V, med2_V, nuovaV, soglia_D, maxdin]=RELAXJr_adjusted_ADJUST (EEG,out)
...
horiz=RELAXJr_beall_horizontal(cwb,topografie,EEG.chanlocs(1,pos_channels),size(EEG.icawinv,2));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
blink=RELAXJr_beall_blink_detection(cwb,topografie,EEG.chanlocs(1,pos_channels),size(EEG.icawinv,2));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
