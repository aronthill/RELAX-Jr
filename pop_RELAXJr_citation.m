...
uilist = {{'style', 'text', 'string', 'If you use RELAX-Jr, please cite the following manuscript, as well as the dependencies you used (details of which can be found in the manuscript)','fontweight','bold','fontsize', 12} ...
          {}...
          {'style', 'text', 'string', 'Hill, A.T., Enticott, P.G., Fitzgerald, P., & Bailey, N. (2024). RELAX-Jr: An automated pre-processing pipeline for developmental EEG recordings.  Human Brain Mapping, 45:e70034','fontsize', 12} ...
          {}...
          };
          ...
          RELAXJr_citation = {'Hill, A.T., Enticott, P.G., Fitzgerald, P., Bailey, N. (2024). RELAX-Jr: An automated pre-processing pipeline for developmental EEG recordings.  Human Brain Mapping, 45:e70034'};
