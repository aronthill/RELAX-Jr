...
function [continuousEEG, epochedEEG] = RELAXJr_blinks_IQR_method(continuousEEG, epochedEEG, RELAX_cfg)
...
%ATH: Blink electrode selection altered to better align with Sensor Nets. 

% set some defaults for included channels and trials, if not specified

% ***NOTE*** default electrodes are in 10-10 naming convention. If users have
% electrodes using another naming convention (e.g., Sensornet 'EL1',
% 'EL2' etc., these should be defined).
    ...
    if exist('RELAX_cfg', 'var')==1
        ...
        if isfield(RELAX_cfg, 'BlinkElectrodes')==0
            %RELAX_cfg.BlinkElectrodes={'FP1';'FPZ';'FP2';'AF3';'AF4';'F3';'F1';'FZ';'F2';'F4';'F9';'F10'}; % sets the electrodes to average for blink detection using the IQR method
            RELAX_cfg.BlinkElectrodes={'E10';'E8';'E5';'E11';'E2';'E12';'E9';'E6';'E3';'E60';'E17';'E1';'E18';'E58'}; % sets the electrodes to average for blink detection using the IQR method
        end
    ...
    BlinkIndexMetric = zeros(1, size(EEGEyeOnly.data, 2)); %Aron added 13 Jul
