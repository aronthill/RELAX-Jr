...
% Specify  RELAX-Jr folder location (this toolbox):
...
RELAX_epoching_cfg.TriggersToEpoch={'HappyGo' 'HappyNogo' 'SadGo' 'SadNogo' }; % triggers to use for epoching (need to edit to match your own!)
...
RELAX_epoching_cfg.BL_correction_method='none';            % Set type of baseline correction to perform ('regression' = recommended for task data, 'subtraction' = traditional but not recommended, 'none' for resting-state data)
...
RELAX_epoching_cfg.CleanedPath=['/Volumes/LaCie_5TB/RELAXJr_test_data/EO/' filesep 'RELAXProcessed' filesep 'Cleaned_Data'];
