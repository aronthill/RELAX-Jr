...
%% RELAXJr_ICA_subtract:

function [EEG] = RELAXJr_ICA_subtract(EEG,RELAX_cfg)
    ...
    elseif strcmp(RELAX_cfg.ICA_method,'amica')
        ...
        mkdir('/Users/aronhill/Documents/MATLAB/amica_temp');
        outdir = '/Users/aronhill/Documents/MATLAB/amica_temp/';
        % Run AMICA:    
        ...
        IC=reshape(OUTEEG.icaact, size(OUTEEG.icaact,1), []);
    elseif strcmp(RELAX_cfg.ICA_method,'picard')
    ...
    %% NWB added section to identify artifactual ICs with Adjusted_ADJUST:
    ...
    if strcmp(RELAX_cfg.Report_all_ICA_info,'yes')
        ...
        EEG.RELAXProcessing_ICA.ProportionICs_was_Brain=sum(I==1)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);
        EEG.RELAXProcessing_ICA.ProportionICs_was_Muscle=sum(I==2)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);
        EEG.RELAXProcessing_ICA.ProportionICs_was_Eye=sum(I==3)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);
        EEG.RELAXProcessing_ICA.ProportionICs_was_Heart=sum(I==4)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);
        EEG.RELAXProcessing_ICA.ProportionICs_was_LineNoise=sum(I==5)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);
        EEG.RELAXProcessing_ICA.ProportionICs_was_ChannelNoise=sum(I==6)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);
        EEG.RELAXProcessing_ICA.ProportionICs_was_Other=sum(I==7)/size(OUTEEG.etc.ic_classification.adjusted_ADJUST.classifications,1);    
